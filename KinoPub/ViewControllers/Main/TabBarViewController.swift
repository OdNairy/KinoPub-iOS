...
class TabBarViewController: UITabBarController, UITabBarControllerDelegate, SideMenuItemContent {
    ...
    func configureVtewControllers() {
        ...
        let n1 =
            storyBoard.instantiateViewController(withIdentifier: "ItemNavVC")
        ...
        n1.viewControllers.first?.tabBarItem = UITabBarItem.init(
            title: "Фильмы", image: UIImage(named: "Movie-50"),
            selectedImage: UIImage(named: "Movie Filled-50"))
        n2.viewControllers.first?.tabBarItem = UITabBarItem.init(
            title: "Сериалы", image: UIImage(named: "TV Show-50"),
            selectedImage: UIImage(named: "TV Show Filled-50"))
        n3.viewControllers.first?.tabBarItem = UITabBarItem.init(
            title: "Мультфильмы", image: UIImage(named: "Minion 2-50"),
            selectedImage: UIImage(named: "Minion 2 Filled-50"))
        n4.viewControllers.first?.tabBarItem = UITabBarItem.init(
            title: "Док. фильмы", image: UIImage(named: "Documentary-50"),
            selectedImage: UIImage(named: "Documentary Filled-50"))
        n5.viewControllers.first?.tabBarItem = UITabBarItem.init(
            title: "Док. сериалы", image: UIImage(named: "Documentary2-50"),
            selectedImage: UIImage(named: "Documentary2 Filled-50"))
        n6.viewControllers.first?.tabBarItem = UITabBarItem.init(
            title: "ТВ Шоу", image: UIImage(named: "Retro TV-50"),
            selectedImage: UIImage(named: "Retro TV Filled-50"))
        n7.viewControllers.first?.tabBarItem = UITabBarItem.init(
            title: "Концерты", image: UIImage(named: "Drum Set-50"),
            selectedImage: UIImage(named: "Drum Set Filled-50"))
    ...
    func configureMoreViewController() {
        ...
        (moreNavigationController.topViewController?.view as? UITableView)?.tintColor =
            UIColor.lightGray
        if let cells = (moreNavigationController.topViewController?.view as? UITableView)?
            .visibleCells {
            for cell in cells {
    ...
    func tabBarController(
        ...
        (tabBarController.view.subviews[1].subviews[1] as? UINavigationBar)?.tintColor =
            UIColor.white
