...
class FilterViewController: FormViewController {
    ...
    func configForm() {
        ...
        PickerInputRow<String>.defaultCellUpdate = { cell, _ in
            cell.backgroundColor = .clear
            cell.textLabel?.textColor = .kpOffWhite
            cell.detailTextLabel?.textColor = .kpGreyishTwo
        }

        PickerInlineRow<String>.defaultCellSetup = { cell, _ in
            cell.textLabel?.textColor = .kpOffWhite
            cell.detailTextLabel?.textColor = .kpGreyishTwo
            cell.tintColor = .kpMarigold
        }

        PickerInlineRow<String>.defaultCellUpdate = { cell, _ in
            cell.textLabel?.textColor = .kpOffWhite
        ...
        PickerInlineRow<SortOption>.defaultCellSetup = { cell, _ in
            cell.textLabel?.textColor = .kpOffWhite
            cell.detailTextLabel?.textColor = .kpGreyishTwo
            cell.tintColor = .kpMarigold
        }
        PickerInlineRow<SortOption>.defaultCellUpdate = { cell, _ in
            cell.textLabel?.textColor = .kpOffWhite
        }

        PickerInlineRow<SubtitlesList>.defaultCellSetup = { cell, _ in
            cell.textLabel?.textColor = .kpOffWhite
            cell.detailTextLabel?.textColor = .kpGreyishTwo
            cell.tintColor = .kpMarigold
        }
        PickerInlineRow<SubtitlesList>.defaultCellUpdate = { cell, _ in
            cell.textLabel?.textColor = .kpOffWhite
        }
